# -*- python -*-
# $Header: /nfs/slac/g/glast/ground/cvs/calibGenCAL/SConscript,v 1.13 2012/01/05 00:52:28 jrb Exp $ 
...
genMuonAsym = progEnv.Program('genMuonAsym',['src/Optical/genMuonAsym.cxx',
                                             'src/Optical/MuonAsymAlg.cxx'])
genMuonMPD = progEnv.Program('genMuonMPD',['src/Optical/genMuonMPD.cxx',
                                           'src/Optical/MuonMPDAlg.cxx'])
genGCRHists = progEnv.Program('genGCRHists',['src/Optical/genGCRHists.cxx',
