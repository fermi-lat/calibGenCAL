...
public:  // i know I'm not supposed to make data members public, but it's just easier this way!
  ...
  string asymFileXML; ///< output xml filename for asymetry calibrations
  ...
  string asymHistFile; ///< output ROOT histogram file - asymetry phase
  string mpdHistFile; ///< output ROOT histogram file - MevPerDac phase

  string pedFileTXT; ///< output txt filename for pedestals
  string asymFileLLTXT; ///< output txt filename for asymetry Large Diode Pos face 2 Large Diode Neg face 
  string asymFileLSTXT; ///< output txt filename for asymetry Large Diode Pos face 2 Small Diode Neg face 
  string asymFileSLTXT; ///< output txt filename for asymetry Small Diode Pos face 2 Large Diode Neg face 
  string asymFileSSTXT; ///< output txt filename for asymetry Small Diode Pos face 2 Small Diode Neg face 
  ...
  double maxAsymLL; ///< used in omission of events w/ bad asymetry logratio
  double maxAsymLS; ///< used in omission of events w/ bad asymetry logratio
  double maxAsymSL; ///< used in omission of events w/ bad asymetry logratio
  double maxAsymSS; ///< used in omission of events w/ bad asymetry logratio
  double minAsymLL; ///< used in omission of events w/ bad asymetry logratio
  double minAsymLS; ///< used in omission of events w/ bad asymetry logratio
  double minAsymSL; ///< used in omission of events w/ bad asymetry logratio
  double minAsymSS; ///< used in omission of events w/ bad asymetry logratio
  
  // SECTION: GENERAL //
  int nEvtRoughPed; ///< number of events for rough pedestal calibration
  int nEvtPed; ///< number of events for Pedestal calibration
  int nEvtAsym; ///< number of events for Asymetry calibration
  ...
  bool readInAsym; ///< skip Asymetry calibration and read in previous results from .txt file
  ...
  bool genOptAsymHists; ///< generate optional asymetry histograms
