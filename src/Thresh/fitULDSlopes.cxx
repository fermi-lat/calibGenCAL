// $Header: /nfs/slac/g/glast/ground/cvs/calibGenCAL/src/Thresh/fitULDSlopes.cxx,v 1.4 2008/05/19 14:17:34 fewtrell Exp $
/** @file
...
int main(const int argc, const char **argv) {
  ...
  try {
    ...
    LogStrm::get() << __FILE__ << ": Opening output ROOT file: " << rootFilePath << endl;
