...
int main(int argc, char** argv)
{
  ...
  gainout << "<?xml version=\"1.0\" ?>" << endl;

  gainout << "<!DOCTYPE calCalib SYSTEM \"calCalib_v2.dtd\" [] >" << endl;

  gainout << "<calCalib>" << endl;

  gainout << "<generic instrument=\"EM\" timestamp=\"2003-10-1-12:56\" calibType=\"CAL_Ped\" fmtVersion=\"v3r3p2\">" << endl;

  gainout << "</generic>" << endl;

  gainout << "<dimension nRow=\"1\" nCol=\"1\" nLayer=\"8\" nXtal=\"12\" nFace=\"2\" />" << endl;

  gainout << "<tower iRow=\"0\" iCol=\"0\">" << endl;

    for (int layer=0;layer <8;layer++){
      gainout << "    <layer iLayer=" << q << layer << q << ">" << endl;
        for(int col=0;col<12;col++){
            gainout << "      <xtal iXtal=" << q << col << q <<">" << endl;
  ...
  gainout << "</tower>" << endl << "</calCalib>" << endl;
