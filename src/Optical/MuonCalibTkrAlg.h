...
#include "src/lib/Util/CalHodoscope.h"
...
namespace calibGenCAL {
  ...
  */
  ...
  public:
    /// \param cfgPath path to optional ini style cfg file w/ non-default alg parms.  set to "" for defaults (supports env var expansion)
  ...
  private:
    ...
    /// 3D LAT coordinate.
    static CalGeom::Vec3D trkToZ(const CalGeom::Vec3D &start,
