// $Header: /nfs/slac/g/glast/ground/cvs/calibGenCAL/src/lib/Util/CalHodoscope.cxx,v 1.1 2007/03/27 18:50:51 fewtrell Exp $
...
void CalHodoscope::addHit(const CalDigi &calDigi) {
  ...
  for (XtalDiode xDiode; xDiode.isValid(); xDiode++) {
    ...
    bestRng[faceIdx]  = calDigi.getRange(0, (CalXtalId::XtalFace)face.val());
