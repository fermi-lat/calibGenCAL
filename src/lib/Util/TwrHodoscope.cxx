// $Header: /nfs/slac/g/glast/ground/cvs/calibGenCAL/src/lib/Util/TwrHodoscope.cxx,v 1.1 2007/03/27 18:50:51 fewtrell Exp $
...
void TwrHodoscope::addHit(const CalDigi &calDigi) {
  ...
  for (XtalDiode xDiode; xDiode.isValid(); xDiode++) {
    ...
    RngIdx    rngIdx  (xtalIdx,
                       face,
                       rng);
    tDiodeIdx diodeIdx(xtalIdx.getTXtalIdx(),
                       xDiode);
