...
namespace CfgMgr {
  ...
  class InvalidVarDef : public std::logic_error {
  public:
  ...
  class DuplicateNameError : public std::logic_error {
  public:
  ...
  class CmdSwitch : public virtual ICmdSwitch {
  public:
    ...
    virtual const std::string &getLongName() const {return longName;}

    virtual char getShortName() const {return shortName;}

    virtual const std::string &getHelp() const {return help;}

    virtual void setVal() {val = true;}

    virtual bool getVal() const {return val;}
  ...
  /// data types
  template <typename _T>
  class CmdOptVar : public virtual ICmdOptVar {
  public:
  ...
  template<typename _T>
  class CmdArg : public virtual ICmdArg {
  public:
    ...
    virtual const std::string &getLongName() const {return name;}
