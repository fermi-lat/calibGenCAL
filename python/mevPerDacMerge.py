...
mevPerDacMerge [-V] <cfg_file> <out_xml_file>
...
if __name__ == '__main__':
    ...
    usage = "mevPerDacMerge [-V] <cfg_file> <out_xml_file>"

    # setup logger

    logging.basicConfig()
    log = logging.getLogger('mevPerDacMerge')
    ...
    for f in inFiles:
        ...
        outData[f.destTwr, :] = energyData[f.srcTwr, :]
