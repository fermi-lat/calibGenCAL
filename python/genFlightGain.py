...
where:
    ...
    <ped_xml_file>  = The CAL_xxx calibration XML file for obtaining values.
"""
...
__author__      = "D.L.Wood"
__date__        = "$Date: 2006/06/15 23:54:00 $"
...
if __name__ == '__main__':
    ...
    fio.write('// Generated by genFlightGain, version %s, on %s\n' % (ver, ts)) 
    ...
    fio.write('// Schema:     calib\n')
    fio.write('// Instance:   metadata_v2r1\n')
    fio.write('// ser_no:     %d\n' % key) 
    fio.write('\n\n')
    
    fio.write('// $Id: genFlightGain.py,v 1.1 2006/06/15 23:54:00 dwood Exp $\n\n')
